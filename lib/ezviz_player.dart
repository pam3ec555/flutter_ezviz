...
class EzvizPlayerController {
  ...
  EzvizPlayerController(int id) {
    ...
    _eventChannel =
        new EventChannel(EzvizPlayerChannelEvents.eventChannelName + "_$id");
  }
  ...
  Future<void> initPlayerByUser(
      int userId, int cameraNo, int streamType) async {
    ...
    await _channel.invokeMethod(
        EzvizPlayerChannelMethods.initPlayerByUser, data);
  }
  ...
  Future<bool> startReplay(DateTime startTime, DateTime endTime) async {
    ...
    return await _channel.invokeMethod(
        EzvizPlayerChannelMethods.startReplay, data);
  }
  ...
  Future<void> setPlayVerifyCode(String verifyCode) async {
    ...
    await _channel.invokeMethod(
        EzvizPlayerChannelMethods.setPlayVerifyCode, data);
  }
}
